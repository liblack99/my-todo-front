...
const Todos: React.FC = () => {
  ...
  return (
    <div className="p-4 bg-gray-100 rounded-md shadow-md w-full sm:w-full md:w-[600px] lg:w-[600px] font-roboto  flex flex-col items-center h-[500px]  transition-all duration-1000 ease-in-out   ">
